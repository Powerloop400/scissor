...
router.post('/register', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, username, email, password, newUser, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, userService.registerUser({ username: username, email: email, password: password })];
            case 2:
                newUser = _b.sent();
                return [4 /*yield*/, userService.authenticateUser(email, password)];
            case 3:
                token = (_b.sent()).token;
